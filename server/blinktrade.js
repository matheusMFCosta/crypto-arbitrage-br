    ...
    /******/ [
            ...
            var BlinkTradeWS = (function(_WebSocketTransport) {
                ...
                function BlinkTradeWS(params) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (BlinkTradeWS.__proto__ || Object.getPrototypeOf(BlinkTradeWS)).call(this, params)
                    );
                ...
                _createClass(BlinkTradeWS, [
                    {
                        ...
                        value: function heartbeat(callback) {
                            ...
                            return _nodeify2.default
                                .extend(
                                    new Promise(function(resolve, reject) {
                                        return _get(
                                            BlinkTradeWS.prototype.__proto__ || Object.getPrototypeOf(BlinkTradeWS.prototype),
                                            "sendMessageAsPromise",
                                            _this2
                                        )
                                            .call(_this2, msg)
                                            .then(function(data) {
                                ...
                                new Promise(function(resolve, reject) {
                                    return _get(
                                        ...
                                        .then(function(data) {
                                            ...
                                            (0,
                                            _listener.registerEventEmitter)({ SecurityStatusReqID: data.SecurityStatusReqID }, function(ticker) {
                                ...
                                if (data.MDBkTyp === "3") {
                                    data.MDIncGrp.map(function(order) {
                                        ...
                                        switch (order.MDEntryType) {
                                            ...
                                            case "1":
                                                var orderbookEvent =
                                                    _actionTypes.ORDER_BOOK + ":" + _actionTypes.EVENTS.ORDERBOOK[order.MDUpdateAction];
                                            ...
                                            case "2":
                                                var tradeEvent =
                                                    _actionTypes.ORDER_BOOK + ":" + _actionTypes.EVENTS.TRADES[order.MDUpdateAction];
                                    ...
                                    return _get(
                                        ...
                                        .then(function(data) {
                                            if (data.MsgType === "W") {
                                                ...
                                                var _data$MDFullGrp$filte = data.MDFullGrp
                                                        ...
                                                        .reduce(function(prev, order) {
                                                            ...
                                                            (prev[side] || (prev[side] = []))
                                                                .push([order.MDEntryPx / 1e8, order.MDEntrySize / 1e8, order.UserID]);
                                                            return prev;
                                                        }, []),
                                    ...
                                    new Promise(function(resolve, reject) {
                                        return _get(
                                            ...
                                            .then(function(data) {
                                                ...
                                                var TradeHistory = _lodash2.default.groupBy(
                                                    _lodash2.default.map(data.TradeHistoryGrp, function(trade) {
                            ...
                            return _get(
                                ...
                                new Promise(function(resolve, reject) {
                                    return _get(
                                        ...
                                        .call(_this9, { currency: currency, value: value, depositMethodId: depositMethodId })
                            ...
                            return _get(
                                ...
                                new Promise(function(resolve, reject) {
                                    return _get(
                                        ...
                                        .call(_this10, { amount: amount, data: data, currency: currency, method: method })
	   ...
	   */
                function WebSocketTransport() {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (WebSocketTransport.__proto__ || Object.getPrototypeOf(WebSocketTransport)).call(this, params, "ws")
                    );
        ...
        /***/ function(module, exports, __webpack_require__) {
            ...
            var BaseTransport = (function(_Base) {
                ...
                function BaseTransport(params, env) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (BaseTransport.__proto__ || Object.getPrototypeOf(BaseTransport)).call(this, params, env)
                    );
	 ...
	 */
            ...
            var BlinkTradeRest = (function(_RestTransport) {
                ...
                function BlinkTradeRest() {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        (BlinkTradeRest.__proto__ || Object.getPrototypeOf(BlinkTradeRest)).apply(this, arguments)
                    );
                }
                ...
                _createClass(BlinkTradeRest, [
                    {
                        ...
                        value: function ticker(callback) {
                            return _get(
                                BlinkTradeRest.prototype.__proto__ || Object.getPrototypeOf(BlinkTradeRest.prototype),
                                "fetchPublic",
                                this
                            ).call(this, "ticker", callback);
                        }
                    },
                    {
                        key: "trades",
                        value: function trades() {
                            ...
                            return _get(
                                ...
                                "fetchPublic",
                                this
                            ).call(this, "trades?limit=" + limit + "&since=" + since, callback);
                        }
                    },
                    {
                        key: "orderbook",
	   ...
	   */
                function RestTransport(params) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (RestTransport.__proto__ || Object.getPrototypeOf(RestTransport)).call(this, params, "rest")
                    );
                ...
                _createClass(RestTransport, [
                    ...
                    },
                    {
                        ...
                        value: function fetchTrade(msg, callback) {
                            ...
                            return _nodeify2.default.extend(
                                this.fetch(msg, "tapi/v1/message", headers, callback)
